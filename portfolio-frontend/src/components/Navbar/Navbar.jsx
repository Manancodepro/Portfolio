...
export default function Navbar() {
    ...
    const bar1 = useRef(null), bar2 = useRef(null), bar3 = useRef(null)
    ...
    // Fade-in on mount
    useEffect(() => {
        gsap.from(navbarRef.current, { y: -80, opacity: 0, duration: 1, ease: 'power3.out', delay: 0.1 })
    }, [])
    ...
    useEffect(() => {
        ...
        if (menuOpen) {
            ...
            gsap.fromTo(
                ...
                { opacity: 0, x: -50 },
                { opacity: 1, x: 0, duration: 0.4, stagger: 0.07, ease: 'power3.out', delay: 0.12 }
            )
            ...
            gsap.to(mobileMenuRef.current, { x: '-100%', opacity: 0, duration: 0.35, ease: 'power3.in' })
