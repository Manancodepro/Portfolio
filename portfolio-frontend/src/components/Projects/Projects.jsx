...
const PROJECTS = [
  {
    ...
    longDesc:
      "A production-ready real-time chat application built with the MERN stack and Socket.io. Features include scheduled message delivery via BullMQ and Redis queues, secure file sharing, real-time typing indicators, JWT-based authentication with refresh tokens, and MongoDB message persistence. Supports multiple chat rooms with live presence indicators.",
    thumb: "💬",
    thumbBg: "linear-gradient(135deg, #7c3aed 0%, #06b6d4 100%)",
    tags: ["MERN", "Socket.io", "JWT", "Redis", "BullMQ"],
    github: "https://github.com/Manancodepro/chatconnect",
    live: "",
    deployed: false,
    accentColor: "#7c3aed",
  ...
  },
  {
    ...
    longDesc:
      "A feature-rich Slack clone built with React and Node.js. Supports real-time messaging, channel creation, direct messaging between users, presence indicators, and message threading. Utilizes Socket.io for real-time updates and MongoDB for data persistence.",
    thumb: "💬",
    thumbBg: "linear-gradient(135deg, #7c3aed 0%, #06b6d4 100%)",
    tags: ["React", "Node.js", "Socket.io", "MongoDB"],
    github: "https://github.com/Manancodepro/SlackClone",
    live: "",
    deployed: false,
    accentColor: "#7c3aed",
    shadowColor: "rgba(124,58,237,0.35)",
  },
  {
    ...
    longDesc:
      "A comprehensive video calling interview platform built with React, Node.js, and WebRTC. Features real-time video conferencing, integrated code editor for live coding assessments, screen sharing, meeting recordings, and interview scheduling. Supports multiple interview types and feedback mechanisms.",
    thumb: "📹",
    thumbBg: "linear-gradient(135deg, #f59e0b 0%, #ef4444 100%)",
    tags: ["React", "WebRTC", "Node.js", "Socket.io"],
    github: "https://github.com/Manancodepro/VideoCallingInterview",
    live: "",
    deployed: false,
    accentColor: "#f59e0b",
  ...
  },
  {
    ...
    longDesc:
      "A full-fledged hospital management system built with React and Node.js. Features include patient management, doctor scheduling, appointment booking, electronic health records (EHR), billing system, prescription management, and admin analytics. Implements role-based access control for different user types.",
    thumb: "🏥",
    thumbBg: "linear-gradient(135deg, #10b981 0%, #0ea5e9 100%)",
    tags: ["React", "Node.js", "MongoDB", "Chart.js"],
    github: "https://github.com/Manancodepro/HospitalManagement",
    live: "",
    deployed: false,
    accentColor: "#10b981",
      ...
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-subtitle">
            Handcrafted digital products that push the boundaries of web
            experiences.
          </p>
        </div>
