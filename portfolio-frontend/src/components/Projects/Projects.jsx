...
const PROJECTS = [
    ...
    },
    {
        ...
        longDesc: 'Replace this with a detailed description of your third project. Include the key features, your technical decisions, and the impact it had.',
        thumb: '🚀',
        thumbBg: 'linear-gradient(135deg, #f59e0b 0%, #ef4444 100%)',
        tags: ['React', 'Node.js', 'MongoDB', 'Tech4', 'Tech5'],
        github: '#',
        live: '#',
        accentColor: '#f59e0b',
    ...
    },
    {
        ...
        title: 'Your Project Title',
        desc: 'A short one-liner description of what this project does and the problem it solves.',
        longDesc: 'Replace this with a detailed description of your fourth project. Include the key features, your technical decisions, and the impact it had.',
        thumb: '⚙️',
        thumbBg: 'linear-gradient(135deg, #10b981 0%, #0ea5e9 100%)',
        tags: ['React', 'Docker', 'CI/CD', 'Node.js', 'Tech5'],
        github: '#',
        live: '#',
        accentColor: '#10b981',
    ...
    },
    {
        ...
        title: 'Your Project Title',
        desc: 'A short one-liner description of what this project does and the problem it solves.',
        longDesc: 'Replace this with a detailed description of your fifth project. Include the key features, your technical decisions, and the impact it had.',
        thumb: '🌐',
        thumbBg: 'linear-gradient(135deg, #8b5cf6 0%, #ec4899 100%)',
        tags: ['Next.js', 'GraphQL', 'AWS', 'Tech4', 'Tech5'],
        github: '#',
        live: '#',
        accentColor: '#8b5cf6',
